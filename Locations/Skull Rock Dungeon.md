...
Skull Rock Dungeon features stone brick walls, dimly lit corridors, and a gauntlet of mechanical traps. The dungeon hallway the party recognized was approximately 100 feet long with stone tile flooring in a brownish color. Six torch sconces line the walls (three per side), concealing hidden trap mechanisms. The corridor is filled with pressure plates that trigger spinning saw blades from the ground and walls, and the torch sconces can be pulled to release gouts of oil that ignite into flames across the entire hallway. The party originally fought through a beach full of skeletons to reach this section.
...
- [[Scoot Sparkles]] - triggered the oil trap mechanism
- [[Lark]] - probed ahead with his weapon, triggering saw blade traps
- [[Ylka]] - used Dimension Door to bypass the traps
- [[Xae]] - teleported with Ylka to the console
