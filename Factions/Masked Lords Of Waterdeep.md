...
The Masked Lords are the secret ruling body of Waterdeep. Their identities are protected by magical masks, and they convene in the [[Masked Lords' Palace]] -- the seat of government in the city. The [[Laeral Silverhand|Open Lord]] (currently [[Laeral Silverhand]]) serves as the sole public face of the council, while the Masked Lords operate in anonymity to insulate the government from external pressure and intrigue.
...
| Name | Role | Status |
|------|------|--------|
| [[Laeral Silverhand]] | Open Lord of Waterdeep | Active -- returned from a long, mysterious absence in S02E38, appearing through a rose-gold portal riding the unicorn [[Lerian\|Lyrian]] |
| [[Dagult Neverember]] | Former Open Lord (deposed) | Exiled to [[Neverwinter]] -- embezzled the city's gold before being replaced by Laeral |
| [[Ramalia Haventree]] | [[Harpers]] representative; presents SWOJ's guild charter | Active |
| [[Force Grey]] | Elite adventuring company serving the Lords | Active |

**Note:** Individual Masked Lords' identities are secret. The [[Necromancer's Ledger]] found in [[The Necromancer]]'s sanctum was bookmarked with names including [[Grim Wavesilver]], [[Mirt]], Coralus Thann, Tharduke Starbuckler, and Jelen Irmbrusk -- suggesting possible connections or targets among the nobility.

## Key Items

- **[[Mask of the Cultivator]]** -- A magical mask associated with the Masked Lords, found in [[The Necromancer]]'s private study. SWOJ traded it to [[Jarlaxle]] in exchange for information about the Necromancer.
- **Guild Charter** -- The official document granting SWOJ recognition as a sanctioned adventuring guild in Waterdeep.
